...
def process_submission_grading(
    ...
    if assignment.reference_solution:
        ...
        try:
            reference_solution = read_file_content(assignment.reference_solution_file_path)
        except Exception as e:
...
def get_submissions(
    ...
    for submission in submissions:
        ...
        if feedback:
            ...
            feedback_response = {
                "overall_assessment": feedback.feedback_text or "",  # Use feedback_text for overall_assessment
                "improvement_suggestions": [detail.issue_description for detail in details],
    ...
    return {
        ...
        "total": len(response_submissions)
    }
